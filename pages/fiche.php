...
<body>
    ...
    <div class="container">
        ...
        <?php } else { ?>
            ...
            <p>
                <a class="btn" href="change_dept.php?emp_no=<?= urlencode($employee['emp_no']) ?>">Changer de département</a>
                <a class="btn btn-secondary" href="become_manager.php?emp_no=<?= urlencode($employee['emp_no']) ?>">Devenir Manager</a>
                <a class="btn btn-secondary" href="emp_form.php?emp_no=<?= urlencode($employee['emp_no']) ?>">Modifier l'employé</a>
            </p>
